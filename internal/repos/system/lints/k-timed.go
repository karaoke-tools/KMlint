...
func KTimed() lint.Lint {
	return lint.Lint{
		Name:        "k-timed",
		Description: "there is at least one k-tag in the lyrics file",
		...
		RunFunc: func(ctx context.Context, KaraData karadata.KaraData) (report.Report, error) {
			...
			return report.FailCritical("songs must not simply be line-timed, they must be syllable-timed"), nil
		},
	}
}
